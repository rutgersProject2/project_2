...
INSERT INTO `address` VALUES (1,NULL,NULL,NULL,NULL,NULL,5,NULL),(2,'fasldf','asdfkl','aslfkj','caksl','29238',NULL,NULL),(3,NULL,NULL,NULL,NULL,NULL,6,NULL),(4,'fasldf','asdfkl','aslfkj','caksl','29238',7,NULL),(5,'fasldf','asdfkl','aslfkj','caksl','29238',8,NULL),(6,'fasldf','asdfkl','aslfkj','caksl','11111',9,NULL),(7,'askdflsadj','234','New City','NY','2399843',10,NULL);
...
INSERT INTO `doctors` VALUES (5,'aaa','sss','ff','dd','awer@agla','23234'),(6,'aaa','sss','ff','dd','awer@agla','23234'),(7,'aaa','sss','ff','dd','awer@agla','23234'),(8,'new doct','sss','ff','dd','awer@agla','23234'),(9,'new doct1','sss','ff','dd','awer@agla','23234'),(10,'asadfs','asdfsdfasd','dkfj23293','asaladf','aslkdjf@gasdkfl','2324343');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `find_patient`(IN p_id int(11))
    COMMENT 'Search for a doctor'
BEGIN
SELECT *
FROM patient_vu
...
-- Dump completed on 2017-12-10 23:28:35
